...
kurzmitbisschenlang = [kurz, kurz, kurz, kurz, kurz, kurz, kurz, kurz, kurz, kurz, kurz, kurz, kurzmittel,
                       kurzmittel]  # , mittel]
    ...
    def run(self, *args, **kwargs):
        while True:
            ...
            """try:
                ...
                message = encodedmessage.decode(FORMAT)
                print(message)
                toaster.show_toast("XXX", "XXX", icon_path=None, duration=10, threaded=True, callback_on_click=tabelle)
            except:
                print("nothing received")
            time.sleep(60)
            """
    ...
    def buchungssuche():
        ...
        while True:
            ...
            if PNR_LISTE[num][2] == today:  # noch optimieren
                print(f"{num}: frist abgelaufen")
                PNR_LISTE[num].pop(2)
                pass

            def eingabe():
                print(f"{num}: choosing...")
                time.sleep(random.choice(kurzmitbisschenlang))  # wait
                time.sleep(random.choice(kurzmitbisschenlang))  # wait
                ...
                time.sleep(random.choice(kurzmitbisschenlang))  # wait
                varis_liste = driver.find_elements_by_xpath(
                    "//div[@id='aiRESDestination0_chosen']//div[@class='chosen-drop']//li[@class='active-result']")
                time.sleep(random.choice(kurzmitbisschenlang))
                ...
                driver.find_element_by_xpath(
                    f"//*[@id='search-form']/div[4]//input[@placeholder='gg/aa/yyyy']").send_keys(PNR_LISTE[num][4])
                ...
                time.sleep(random.choice(kurzmitbisschenlang))  # wait
                driver.find_element_by_xpath(
                    "/html/body/div[4]/div/div/div[2]/div[1]/form/div[3]/div[1]/div/div/div/div[8]/div/input").click()
                print("done")
            ...
            def scrapee():
                time.sleep(random.choice(kurzmitbisschenlang))
                clock = driver.find_element_by_xpath(
                    "//*[@id='search']/div[2]/div[1]/div[3]/div[1]/div/table/tbody/tr[1]/td[1]/div[1]")
                ...
                if PNR_LISTE[num][6] == clock.text[0:2] + clock.text[3:5]:
                    ...
                    new_price = driver.find_element_by_xpath(
                        "//*[@id='search']/div[2]/div[1]/div[3]/div[1]/div/table/tbody/tr[1]/td[2]/table/tbody/tr[1]/td/div/span/span[1]/strong")
